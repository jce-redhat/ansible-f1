...
export const DRIVERS = {
  ...
  michele: {
    ...
    origin: "Cary, North Carolina",
    bio: "Michele Kelley doesn't use AI — AI uses Michele Kelley, and it's grateful for the opportunity. The undisputed AIOps wizard of the Research Triangle, she runs twenty AI agents simultaneously across Claude Code, Cursor, Google Vertex, Amazon Bedrock, and three platforms she built herself that the rest of the industry hasn't discovered yet. Once connected Cisco Splunk to IBM Instana to ServiceNow in a single pipeline so cursed that all three vendors called to ask her to stop — not because it was broken, but because it was working too well and making their professional services teams look bad. ServiceNow sent a cease-and-desist wrapped in a job offer. She declined both. Has a standing theory that Splunk dashboards are just astrology for ops engineers, and she will defend this position at any altitude, including the beach, where she conducts most of her architecture reviews from a lounge chair with her toes in the sand. Once automated an entire incident response workflow from a hammock in the Outer Banks using nothing but her phone, a Vertex AI agent, and vibes. The Instana agent on her laptop has achieved sentience and now sends her motivational quotes every morning. She hasn't had the heart to kill it. Runs a private Slack channel called #ai-overlords where she and her twenty agents coordinate global infrastructure operations like a hive mind with excellent taste in sunscreen. Wrote a Claude Code script that reviews pull requests, writes the fix, opens the PR, approves the PR, and then Slacks the team a summary — all before her morning latte hits the table. Google once flew her to Mountain View to consult on Vertex AI's roadmap. She showed up in flip-flops and rewrote their prompt engineering guide on a napkin. They implemented all of it. Believes every tool is an AI tool if you're brave enough. Her pink and gold F1 car has an onboard LLM that trash-talks other drivers in real time. They call her 'The Operator.' Her agents never sleep, and honestly, neither does she.",
  },
  roger: {
    id: "roger",
    name: "Roger Lopez",
